...
public class LoginBean extends HttpServlet {
	...
	public String getResult() {
		...
		if (logged) {
			...
			sb.append("<p>Du brauchst noch einen Account? Hier geht es zur <a class=\"simple-link\" href=\"ControllerServlet?doAction=register\">Registrierung</a>.</p>"
							+ "<br>"
							+ "    	<br>"
							+ "    	<FORM ACTION=\"ControllerServlet?doAction=login\" METHOD=\"POST\">"
							+ "    	<p class=\"text-white-large\">Benutzername </p><input type=\"text\" name=\"username\"></input>"
							+ "    	<p class=\"text-white-large\">Passwort </p><input type=\"password\" name=\"password\"></input><br><br>"
